			...
			<form id="sidebar_form">
				<div class="radio_blocks">
					<div class="radio_block">
						<div class="radio_col">
							<input type="radio" name="orenda_prodazha" value="2" id="input_radio_rent">
				...
				<?php 
					...
					if($valut=='eur'||$valut=='uah'){
						...
						$res->free();
						if($valut=='uah'){
							$price_min=round($price_min*$curs_usd);
							$price_max=round($price_max*$curs_usd);
						} else if($valut=='eur'){
							$price_min=round($price_min*$curs_usd/$curs_eur);
							$price_max=round($price_max*$curs_usd/$curs_eur);
						}
					}
				...
				<div class="radio_blocks">
					...
					<div class="radio_col">
						<input type="radio" name="s_remontom_bez" value="2" id="bez_remonta">
				...
				<input type="hidden" name="valut" value="<?php echo $valut; ?>">
				<?php  
					if(!empty($_GET['page'])){
						$page=$_GET['page'];
					} else {
				...
				<button id="sbros" type="submit">Скидання</button>
			</form>
		</div>